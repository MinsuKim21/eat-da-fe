  ...
  return (
    <div>
      <div className="w-[343px] h-[120px] bg-zinc-300 rounded-lg flex justify-between pt-[15px] px-[15px]">
        <div>
          <div className="text-[15px] font-bold font-['Inter'] leading-[18px] mb-[2px]">
            음식점 이름
          </div>
          <div className=" text-[10px] font-medium font-['Inter'] leading-[14px] mb-[28px]">
            주소
          </div>
          <div className=" text-xs font-semibold font-['Inter'] mb-[4px]">
            영업일/시간
          </div>
      ...
      <div className="w-[344px] h-10 bg-black rounded-[9px] flex justify-center items-center">
        <IconButton className="w-[162px] h-5 text-white text-[17px] font-extrabold font-['Inter'] leading-snug">
          MENU
        </IconButton>
      </div>
    </div>
